...
### הדבר הכי דחוף: Cold Start + Onboarding

האפליקציה היא **מוצר מרשים מבחינה טכנית** — AI coaching בזמן אמת, pose detection, פידבק קולי בעברית, תמיכה בפרוטזה. אבל שני דברים הורגים את הרושם הראשוני:

1. **Cold Start של 30+ שניות** — משתמש חדש שמנסה לראשונה חושב שהאפליקציה שבורה. הוא לא ימתין. פתרון: $7/חודש ל-Render Starter, או cron ping חינמי.

2. **אין Onboarding** — משתמש חדש מגיע ל-Dashboard ריק. הוא לא יודע שצריך למלא פרופיל, לבחור ספורט, ולהגדיר מטרות. חצי מהמשתמשים יעזבו כאן.
