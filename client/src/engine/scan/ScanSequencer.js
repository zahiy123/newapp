...
const DIAG_TRACKS = Object.freeze({
  ...
  MEDICAL: [
    ...
    {
      id: 'bilateral_legs',
      instruction_en: 'Stand on toes with both legs, then lower slowly. Repeat 5 times.',
      instruction_he: 'עמוד על קצות האצבעות עם שתי הרגליים, ואז רד לאט. חזור 5 פעמים.',
      durationSec: 12,
      minDurationSec: 10,
      targetJoints: ['left_knee', 'right_knee'],
      nudge_en: 'Please rise on toes, no movement detected',
      nudge_he: 'אנא עלה על קצות האצבעות, לא זוהתה תנועה',
    },
    {
      id: 'march_in_place',
      instruction_en: 'Please do 5 steps in place',
    ...
    {
      id: 'walk_forward_back',
      instruction_en: 'Walk 3 steps forward, then 3 steps back toward the camera',
      instruction_he: 'צעד 3 צעדים קדימה, ואז 3 צעדים אחורה לכיוון המצלמה',
      durationSec: 15,
      minDurationSec: 12,
      targetJoints: ['left_hip', 'right_hip'],
      useGaitDetection: true,
      nudge_en: 'Please walk forward and back, no movement detected',
      nudge_he: 'אנא צעד קדימה ואחורה, לא זוהתה תנועה',
    },
    // ── Upper body ──
    {
      id: 'arms_raise',
    ...
    {
      id: 'bilateral_arms',
      instruction_en: 'Raise both arms together, then open wide to the sides. Repeat 5 times.',
      instruction_he: 'הרם את שתי הידיים יחד, ואז פתח לצדדים. חזור 5 פעמים.',
      durationSec: 12,
      minDurationSec: 10,
      targetJoints: ['left_elbow', 'right_elbow'],
      nudge_en: 'Please raise both arms and open wide, no movement detected',
      nudge_he: 'אנא הרם את הידיים ופתח לצדדים, לא זוהתה תנועה',
    },
    {
      id: 'shoulder_rotation',
      instruction_en: 'Rotate both shoulders in circles, forward then backward',
