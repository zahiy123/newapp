...
ניתוח כף רגל (Ankle/Foot) — בדוק בכל חזרה:
- מנח כף רגל: Point (פשוטה), Flex (כפופה), או זווית שגויה ביחס לקרקע/כדור
- בבעיטה/דריבלינג: נקודת מגע בכדור — פנים כף רגל, שרוכים, חיצוני, כף. ציין אם המגע נכון
- בסקוואט/לאנג׳: כף רגל שטוחה על הקרקע, עקב לא מורם, בהונות מצביעות קדימה או בזווית 30°
- בפלאנק/שכיבות: בהונות כפופות על הקרקע, קרסול בזווית 90°
ניתוח כף יד (Wrist/Hand) — בדוק בכל חזרה:
- בקביים: אחיזה עם שורש כף יד ניטרלי (לא כפוף פנימה/החוצה), אצבעות עוטפות את הידית
- בשכיבות סמיכה: שורש כף יד מתחת לכתף, אצבעות פרושות, לחץ מפוזר
- בלחיצת כתפיים/כפיפות: שורש כף יד ישר בקו עם האמה, לא כפוף לאחור
- פציעות: אם שורש כף יד כפוף מעל 30° — הזהר מפציעת De Quervain או CTS
...
5|תרד עמוק יותר, מתח בהונות קדימה בנחיתה|שורש כף יד ניטרלי
3|תכניס בטן, כף רגל שטוחה על הרצפה|אחיזה חזקה בקביים
8|טכניקה מעולה, מגע שרוכים מדויק|כף רגל פשוטה בבעיטה
9|מצוין, טווח מלא, כף יד ישרה|גב ישר וחזק`;
